...
<head>
    <meta charset='utf-8'>
    <title>Regisztráció2 - Szakdolgozatok</title>
    ...
    <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                ...
                <li class="nav-item">
                    <a class="nav-link active link-secondary text-uppercase" href="temavezeto_regist.php">Témavezetői regisztráció</a>
                </li>
                <li class="nav-item">
...
<div class="container bg-light">
    <main >
        <section>
            <div>
                <h2>
                    Regisztráció - Témavezető
                </h2>
                <form action="temavezeto_regist.php" method="POST" id="regist_temavezeto" class="mb-3">
                    <fieldset>
                        ...
                        <label for="szerepkor" class="form-label required-label">Szerepkör: </label>
                        <select id="szerepkor" name="szerepkor" class="form-select">
                            <option value="belső">Belső</option>
                            <option value="külső" disabled>Külső - nem regisztrálhat magától!</option>
                        </select> <br>
                        ...
                        <div class="buttons">
                            <input class="btn btn-success" type="submit" value="Regisztrálás" name="Regisztrálás">
                        </div>
                    </fieldset>
                    <p>
                        <small>
