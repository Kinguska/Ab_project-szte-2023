...
$message = "";
if (isset($_POST["hallgato_delete"])){
    $errors = [];
    ...
    <main class="container-fluid">
        ...
        if (isadmin($_SESSION['egyetemi_azonosito'])){
            if (isset($_SESSION['egyetemi_azonosito'])){
                ?>
                <div>
                    <form action="delete_hallgato.php" method="post" id="delete_h">
                        <fieldset>
                            <label for="egyetemi_azonosito" class="form-label required-label" >Hallgató azonosítója: </label>
                            <select id="egyetemi_azonosito" name="egyetemi_azonosito" class="form-select">
                            ...
                            <div class="buttons">
                                <input class="btn btn-danger" type="submit" value="Hallgató törlése" name="hallgato_delete">
                            </div>
                        </fieldset>
                    </form>
                </div>
