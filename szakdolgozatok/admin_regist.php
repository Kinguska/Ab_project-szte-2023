...
if(isset($_POST["Regisztrálás"])){
    ...
    $_POST["munkakori_beosztas"] = "adminisztrátor";
...
<head>
    <meta charset='utf-8'>
    <title>Regisztráció3 - Szakdolgozatok</title>
    ...
    <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                ...
                <li class="nav-item">
                    <a class="nav-link active link-secondary text-uppercase" href="admin_regist.php">Adminisztrátori regisztráció</a>
                </li>
            </ul>
        </div>
    </div>
...
<div class="container bg-light">
    <main >
        <section>
            <div>
                <h2>
                    Regisztráció - Adminisztrátor
                </h2>
                <form action="admin_regist.php" method="POST" id="regist_admin" class="mb-3">
                    <fieldset>
                        ...
                        <div class="buttons">
                            <input class="btn btn-warning" type="submit" value="Regisztrálás" name="Regisztrálás">
                        </div>
                    </fieldset>
                    <p>
                        <small>
